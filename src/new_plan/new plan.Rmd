...
pcs1 %>%
  ...
  theme(legend.position = "none") + ggtitle("Obesity defined by BMI")
...
pcs1 %>%
  ...
  scale_color_manual(values = c("#964B00", "#8F00FF",  "#0000FF", "#00FF00", 
    ...
    geom_mark_ellipse(aes(color = cl_hierarchical,
                    ...
                    expand = unit(0.5,"mm"),
                    label.buffer = unit(-5, 'mm')) +
  theme(legend.position = "none") + ggtitle("Obesity defined by waist circumference")
...
pcs1 %>%
  ...
  scale_color_manual(values = c("#964B00", "#8F00FF",  "#0000FF", "#00FF00", 
    ...
    geom_mark_ellipse(aes(color = cl_hierarchical,
                    ...
                    expand = unit(0.5,"mm"),
                    label.buffer = unit(-5, 'mm')) +
  theme(legend.position = "none") + ggtitle("Obesity defined by w2hratio")
```
...
pcs1 %>% group_by(cl_kmeans) %>% 
  summarise(prop_obese = sum(as.numeric(obese_BMI))/n())
```
